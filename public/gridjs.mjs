...
var u, l, c, p, h, f, d, _ = {}, m = [], g = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
...
function b(t, e, n) {
    ...
    if (arguments.length > 2 && (s.children = arguments.length > 3 ? u.call(arguments, 2) : n), "function" == typeof t && null != t.defaultProps) for (o in t.defaultProps) void 0 === s[o] && (s[o] = t.defaultProps[o]);
...
function F(t, e, n, r, i, o, s, a, u, l) {
    ...
    for (n.__k = [], c = 0; c < e.length; c++) if (null != (f = n.__k[c] = null == (f = e[c]) || "boolean" == typeof f ? null : "string" == typeof f || "number" == typeof f || "bigint" == typeof f ? w(null, f, null, null, f) : Array.isArray(f) ? w(S, {children: f}, null, null, null) : f.__b > 0 ? w(f.type, f.props, f.key, null, f.__v) : f)) {
...
function L(t, e, n, r, i) {
    ...
    t:if ("style" === e) if ("string" == typeof n) t.style.cssText = n; else {
        if ("string" == typeof r && (t.style.cssText = r = ""), r) for (e in r) n && e in n || R(t.style, e, "");
        if (n) for (e in n) r && n[e] === r[e] || R(t.style, e, n[e])
    } else if ("o" === e[0] && "n" === e[1]) o = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + o] = n, n ? r || t.addEventListener(e, o ? I : A, o) : t.removeEventListener(e, o ? I : A, o); else if ("dangerouslySetInnerHTML" !== e) {
...
function U(t, e, n, r, i, o, s, a, u) {
    ...
    try {
        t:if ("function" == typeof x) {
            ...
            if (p.context = b, p.props = g, p.__v = e, p.__P = t, w = l.__r, k = 0, "prototype" in x && x.prototype.render) p.state = p.__s, p.__d = !1, w && w(e), c = p.render(p.props, p.state, p.context); else do {
...
function M(t, e, n, r, i, o, s, a) {
    var l, c, p, h = n.props, f = e.props, d = e.type, m = 0;
    if ("svg" === d && (i = !0), null != o) for (; m < o.length; m++) if ((l = o[m]) && "setAttribute" in l == !!d && (d ? l.localName === d : 3 === l.nodeType)) {
        t = l, o[m] = null;
        break
    }
    if (null == t) {
    ...
    if (null === d) h === f || a && t.data === f || (t.data = f); else {
        if (o = o && u.call(t.childNodes), c = (h = n.props || _).dangerouslySetInnerHTML, p = f.dangerouslySetInnerHTML, !a) {
            if (null != o) for (h = {}, m = 0; m < t.attributes.length; m++) h[t.attributes[m].name] = t.attributes[m].value;
        ...
        }(t, f, h, i, a), p) e.__k = []; else if (m = e.props.children, F(t, Array.isArray(m) ? m : [m], e, n, r, i && "foreignObject" !== d, o, s, o ? o[0] : n.__k && P(n, 0), a), null != o) for (m = o.length; m--;) null != o[m] && y(o[m]);
...
function j(t, e, n) {
    ...
    if (r = t.__k) for (i = 0; i < r.length; i++) r[i] && j(r[i], e, "function" != typeof t.type);
...
function K(t, e) {
    return b($, {content: t, parentElement: e})
}
...
var ft =/*#__PURE__*/function () {
    ...
    return r(e, t), e.prototype.render = function () {
        ...
        if (this.props.pluginId) {
            ...
            return e ? b(S, {}, b(e.component, n({plugin: e}, e.props, this.props.props))) : null
        }
    ...
    return n.componentWillUnmount = function () {
        ...
        }), b("div", {className: rt(it("search", this.config.className.search))}, b("input", {
            type: "search",
...
var mt =/*#__PURE__*/function (t) {
    ...
    return i.componentWillMount = function () {
        ...
        return this.props.enabled ? b("div", {className: it(rt("pagination"), this.config.className.pagination)}, this.renderSummary(), b("div", {className: rt("pages")}, this.props.prevButton && b("button", {
            tabIndex: 0,
            role: "button",
...
vt.defaultProps = {summary: !0, nextButton: !0, prevButton: !0, buttonsCount: 3, limit: 10, resetPageOnUpdate: !0};
var wt =/*#__PURE__*/function (t) {
    ...
    return i.widths = function () {
        ...
        var t = Array.from(this.base.parentNode.querySelectorAll("thead th")).reduce(function (t, e) {
            var r;
            return e.style.width = e.clientWidth + "px", n(((r = {})[e.getAttribute("data-column-id")] = {minWidth: e.clientWidth}, r), t)
        }, {});
...
var St =/*#__PURE__*/function (t) {
        ...
        return o.adjustWidth = function (t) {
            var e = t.container, n = t.tableRef, r = t.tempRef, o = t.tempRef || !0;
            if (!e) return this;
            var s = e.clientWidth, u = {current: null}, l = {};
            if (n.current && o) {
                var c = b(wt, {tableRef: n});
            ...
            for (var r, i = a(e || this.columns || []); !(r = i()).done;) {
                var o = r.value;
                o.columns && o.columns.length > 0 && (o.sort = {enabled: !1}), void 0 === o.sort && t.sort && (o.sort = {enabled: !0}), o.sort ? "object" == typeof o.sort && (o.sort = n({enabled: !0}, o.sort)) : o.sort = {enabled: !1}, o.columns && this.setSort(t, o.columns)
            }
            ...
            for (var r, i = a(e); !(r = i()).done;) {
                var o = r.value;
                void 0 !== o.plugin && t.plugin.add(n({id: o.id, props: {}}, o.plugin, {position: ot.Cell}))
            }
        }, i.fromColumns = function (t) {
            for (var e, n = new i, r = a(t); !(e = r()).done;) {
                var o = e.value;
                if ("string" == typeof o || p(o)) n.columns.push({name: o}); else if ("object" == typeof o) {
                    var s = o;
...
var Lt, At =/*#__PURE__*/function (t) {
...
}(et), Ot =/*#__PURE__*/function () {
    function t() {
    }

    return t.createFromConfig = function (t) {
        var e = new At;
        return t.storage instanceof Nt && e.register(new Ht({serverStorageOptions: t.server})), e.register(new It({storage: t.storage})), e.register(new Mt({header: t.header})), e.register(new Ut), e
    }, t
    ...
    return e.assign = function (t) {
        ...
        var r = new t(e);
        return r._userConfig = e, "boolean" == typeof e.sort && e.sort && r.assign({sort: {multiColumn: !0}}), r.assign({header: St.fromUserConfig(r)}), r.assign({storage: Et.createFromUserConfig(e)}), r.assign({pipeline: Ot.createFromConfig(r)}), r.assign({translator: new G(e.language)}), r.plugin.add({
            id: "search",
            position: ot.Header,
            component: _t,
            props: n({enabled: !0 === e.search || e.search instanceof Object}, e.search)
        }), r.plugin.add({
            id: "pagination",
            position: ot.Footer,
            component: vt,
            props: n({enabled: !0 === e.pagination || e.pagination instanceof Object}, e.pagination)
...
var Wt, Bt, zt, qt, Vt =/*#__PURE__*/function (t) {
    ...
    return n.getColumn = function (t) {
        ...
        return this.props.children ? this.props.children : b(S, null, this.props.row.cells.map(function (e, n) {
            var r = t.getColumn(n);
            return r && r.hidden ? null : b(Vt, {key: e.id, cell: e, row: t.props.row, column: r})
        }))
    }, n.render = function () {
        return b("tr", {
...
}(X), Xt =/*#__PURE__*/function (t) {
    function e() {
        return t.apply(this, arguments) || this
    }

    return r(e, t), e.prototype.render = function () {
        return b(Gt, {messageRow: !0}, b(Vt, {
            role: "alert",
            colSpan: this.props.colSpan,
            messageCell: !0,
    ...
    return n.headerLength = function () {
        ...
        var t = this;
        return b("tbody", {className: it(rt("tbody"), this.config.className.tbody)}, this.props.data && this.props.data.rows.map(function (e) {
            return b(Gt, {key: e.id, row: e, header: t.props.header})
    ...
    return i.validateProps = function () {
        ...
        for (var n, r = 0, i = a(this.props.columns); !(n = i()).done;) {
            var o = n.value;
            if (0 !== r) break;
            var s = t.cells[o.index].data, u = e.cells[o.index].data;
    ...
    return i.componentWillUnmount = function () {
        ...
        return r.length > 0 ? e = r[0] : (this.updateSortProcessorFn = this.updateSortProcessor.bind(this), this.store.on("updated", this.updateSortProcessorFn), e = t === Y.ServerSort ? new Jt(n({columns: this.store.state}, this.config.sort.server)) : new Kt({columns: this.store.state}), this.config.pipeline.register(e)), e
    ...
    return i.isSortable = function () {
        ...
        }, this.getCustomAttributes(), t), b("div", {className: rt("th", "content")}, this.content()), this.isSortable() && b(Qt, n({
            ref: this.sortRef,
    ...
    return r(e, t), e.prototype.render = function () {
        return b("table", {
            ...
            style: n({}, this.config.style.table, {height: this.props.height})
        }, b(ne, {header: this.props.header}), b($t, {
            data: this.props.data,
            status: this.props.status,
            header: this.props.header
        }))
    }, e
}(X), ie =/*#__PURE__*/function (t) {
    function e(e, n) {
        var r;
        return (r = t.call(this, e, n) || this).headerRef = {current: null}, r.state = {isActive: !0}, r
    }
    ...
    return i.componentDidMount = function () {
        ...
        }, b(dt, {position: ot.Header})) : null
    }, e
}(X), oe =/*#__PURE__*/function (t) {
    function e(e, n) {
        var r;
        return (r = t.call(this, e, n) || this).footerRef = {current: null}, r.state = {isActive: !0}, r
    }
    ...
    return i.componentDidMount = function () {
        ...
        }, b(dt, {position: ot.Footer})) : null
    }, e
}(X), se =/*#__PURE__*/function (t) {
    function e(e, n) {
        var r;
        ...
        }(), r.state = {status: Lt.Loading, header: e.header, data: null}, r
    }
    ...
    return i.processPipeline = function () {
        try {
            var t = this;
            t.props.config.eventEmitter.emit("beforeLoad"), t.setState({status: Lt.Loading});
            var e = function (e, n) {
                try {
                    var r = Promise.resolve(t.props.pipeline.process()).then(function (e) {
                        t.setState({data: e, status: Lt.Loaded}), t.props.config.eventEmitter.emit("load", e)
                    })
                } catch (t) {
                    return n(t)
                }
                ...
                pt.error(e), t.setState({status: Lt.Error, data: null})
            });
        ...
        e.status != Lt.Rendered && this.state.status == Lt.Loaded && (this.setState({status: Lt.Rendered}), this.props.config.eventEmitter.emit("ready"))
    }, i.render = function () {
        return b(this.configContext.Provider, {value: this.props.config}, b("div", {
            ...
            style: n({}, this.props.config.style.container, {width: this.props.width})
        }, this.state.status === Lt.Loading && b("div", {className: rt("loading-bar")}), b(ie, null), b("div", {
        ...
        })), b(oe, null), b("div", {ref: this.props.config.tempRef, id: "gridjs-temp", className: rt("temp")})))
    }, e
}(X), ae =/*#__PURE__*/function (t) {
    function e(e) {
        var n;
...
}(tt), ue = 0, le = [], ce = [], pe = l.__b, he = l.__r, fe = l.diffed, de = l.__c, _e = l.unmount;
